...
/**
	...
	* @retval 	Нет
  */
void CS43L22_init(I2C_HandleTypeDef CS43L22_i2c_for_init, GPIO_TypeDef* CS43L22_reset_port_for_init, uint16_t CS43L22_reset_pin_for_init) {
	...
	CS43L22_i2c_write(CS43L22_REG_ADDR_ANALOG_ZC_SR_SETTINGS, CS43L22_REG_ANALOG_ZC_SR_SETTINGS_WR_NOT_OCCUR_SOFT_RAMP);
	...
	CS43L22_i2c_write(CS43L22_REG_ADDR_VOLUME_PCMA, 					0x0A);
	CS43L22_i2c_write(CS43L22_REG_ADDR_VOLUME_PCMB, 					0x0A);
}
